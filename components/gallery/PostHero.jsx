        ...
        <section className="bg-surface-container-lowest py-48">
            <div className="max-w-[1440px] mx-auto px-12 grid grid-cols-12 items-center gap-24">
                ...
                <div className="col-span-12 md:col-span-5">
                    <span className="font-[Playfair_Display] text-primary tracking-[0.4em] uppercase text-xs mb-8 block">The Philosophy</span>
                    <h2 className="font-[Playfair_Display] text-6xl text-on-surface leading-tight mb-12 italic">Lorem ipsum</h2>
