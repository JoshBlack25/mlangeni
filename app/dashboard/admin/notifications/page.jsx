        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex h-11 items-center gap-2 rounded-full bg-[#D4AF37] px-4 text-sm font-semibold text-black transition hover:bg-[#c4a132]"
            >
              <Send size={15} />
              Send Notification
            </button>
